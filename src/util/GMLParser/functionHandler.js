...
const functions = (out) => {
  ...
  return {
    ...
    set_attack_value(attack, index, value){
      ...
      if (!out.attacks[attackName]) out.attacks[attackName] = { windows: [], hitboxes: [] };
      if (indexName === 'AG_NUM_WINDOWS') out.attacks[attackName].windows.length = trueValue;
      out.attacks[attackName][indexName] = trueValue;
    },
    ...
    set_window_value(attack, window, index, value){
      ...
      if (!out.attacks[attackName].windows[windowNum - 1]) {
        out.attacks[attackName].windows[windowNum - 1] = {};
      }
      out.attacks[attackName].windows[windowNum - 1][indexName] = trueValue;
    },
    ...
    set_hitbox_value(attack, hitbox, index, value){
      ...
      if (!out.attacks[attackName].hitboxes[hitboxNum - 1]) {
        out.attacks[attackName].hitboxes[hitboxNum - 1] = {};
      }
      out.attacks[attackName].hitboxes[hitboxNum - 1][indexName] = trueValue;
    },
    ...
    set_num_hitboxes(attack, value){
      let attackName = getData(attack);
      let trueValue = getData(value);
      out.attacks[attackName].hitboxes.length = trueValue;
    },
