...
const getNewBase = () => {
  ...
  base.resources.bgImage.data.src = './images/stage_bg.png';
  ...
  base.resources.stageImage.data.src = './images/stage_base.png';
  ...
  base.resources.platformImage.data.src = './images/stage_platform.png';
